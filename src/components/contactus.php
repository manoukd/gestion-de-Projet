...
<section class="px-md-5 mx-md-5 text-center dark-grey-text">
  ...
  <div id="map-container-google-1" class="z-depth-1 map-container mb-5">
    <img src="../src/images/Female-UI-And-UX-Designers1.png" frameborder="0"
      style="border:0">
  </div>
  <!--Google Maps-->
  ...
  <div class="row d-flex justify-content-center mb-5">
    ...
    <div class="col-md-6 text-center">
      ...
      <div class="md-form md-outline mb-3">
        ...
        <label for="form-message">Comment pouvons nous vous aider ?</label>
      </div>
  ...
  <div class="row text-center">
    ...
    <div class="col-lg-4 col-md-12 mb-4 mb-md-0">
      ...
      <p class="font-weight-bold my-3">Addresse</p>

      <p class="text-muted">ville, 94126, pays</p>
    ...
    <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
        ...
        <p class="font-weight-bold my-3">Numero De Telephone</p>

        <p class="text-muted">+ 237 6xx xxx xxx</p>
    ...
    <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
        ...
        <p class="text-muted">adresse@gmail.com</p>
