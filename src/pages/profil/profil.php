        ...
        <section>
          ...
          <div class="list-group list-group-flush z-depth-1 rounded">
            <div class="list-group-item active d-flex justify-content-start align-items-center py-3">
              <img src="../src/images/230221-illustration-de-caractere-developpeur-business-girl-gratuit-vectoriel.jpg" class="rounded-circle z-depth-0" width="50" alt="avatar image">
